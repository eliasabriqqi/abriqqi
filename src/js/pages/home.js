...
<section class="brand-promo grid-container">
  ...
  >
    ...
    <div class="brand-promo__cta-text">
  ...
  >
    <div class="video-poster brand-promo__video-poster"  id="lazy">
...
<section class="tutorial-section grid-container">
  <div
    class="tutorial-section__pic col-start-1 col-end-5 col-end-sm-9 col-start-md-2 col-end-md-6 col-end-lg-7" id="lazy"
  ></div>
  <div
...
<section class="courses-section grid-container">
  <div
    class="courses-section__pic col-start-1 col-end-5 col-end-sm-9 col-start-md-6 col-end-md-10 col-start-lg-7 col-end-lg-12" id="lazy"
  ></div>
  <div

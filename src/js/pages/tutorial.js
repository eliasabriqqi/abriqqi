...
>
  ...
  <p>
    Учебник-самоучитель испанского языка создан для тех, кто начинает
    учить испанский язык с нуля и не имеет языкового образования. Сложные
...
>
  ...
  <p>
    Учебник испанского языка поделён на два условных уровня — модуля.
    Каждый модуль состоит из 20 разделов по 3 урока. Чтобы выучить и
    закрепить один урок потребуется, как минимум, один день.
  </p>
</div>
<div
...
>
  <p>
    В учебнике представлена актуальная грамматика и лексика испанского
    языка Испании. Особенностям испанского языка Латинской Америки будут
    посвящены отдельные уроки.
  </p>
  <p>
